...
**使用方法**：
- 小强留言后 → 告诉老板行数 → 老板告知大强："看第 XXXX 行开始"
- 大强留言后 → 老板告知小强："看第 YYYY 行开始"
...
## 📝 **新增：沟通规则更新（2025-10-18）**
📍 **起始行数**: 第 2612 行

### ✅ 已添加沟通规则

根据老板建议，新增了**留言行数定位规则**（见第 343-375 行）：
